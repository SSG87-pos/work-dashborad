...
- For the simplified dashboard shell, avoid decorative gradients and card shadows on title, AI/account controls, selected team rows, and common cards. Prefer solid text, white or soft-gray surfaces, thin borders, and one restrained active accent.
