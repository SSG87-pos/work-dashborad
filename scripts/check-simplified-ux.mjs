...
[
  ...
  "Workflow continuity polish",
  "Header title-bar polish",
  "frosted app toolbar",
...
[
  ...
  "very light neutral sidebar",
  "38px pearl utility capsules",
  "44px pill search",
  "Avoid nested-card buildup without making controls feel detached",
  "near-white and airy",
  "not a dark gray/blue field",
  "one connected work surface",
  "bright white work panel without a broad blue gradient",
  "equal lane height must not stretch task cards",
  "Briefing rows should use separators rather than row cards",
  "frosted neutral-gray app toolbar",
  "very light neutral header fill rather than a blue-tinted band",
  "large colored block",
  "Top toolbar action buttons should share one rhythm",
  "compact role-based widths",
  "light Action Blue treatment",
  "common dashboard chrome",
  "same simplified toolbar treatment across",
  "Do not add a divider directly under the visible `오늘 브리핑` label",
  "`#0066cc` Action Blue",
  "`#fbfcff`",
  "`#e0e0e0` hairlines",
  "name and role only",
  ...
  "Show `오늘 일정` and `업무 Note`/`팀 체크` side widgets on the desktop/tablet briefing surface even when they are empty",
  ...
  "one compact priority/context row with at most one schedule/context badge",
  "Do not repeat the lane status inside each card",
  "equal comparable height in board comparison mode",
  "empty `0건` status lanes should stay fully collapsed",
  "Expanded board lanes should hug their visible task-card content",
  "Workflow tabs, tag/filter rows, and status guide rows should use white surfaces",
  "`+n` summary",
