...
responses.set("GET /ai/wiki/recommendations", [{ task_id: taskId, task_title: "회사 백엔드 검증", score: 0.9, reasons: ["완료된 업무"] }]);
...
await apiDashboardStore.ai.wiki.recommendations();
...
assert.ok(calls.some((call) => call.key === "GET /ai/wiki/recommendations"));
