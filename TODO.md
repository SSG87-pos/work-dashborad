...
- [x] Implement simplified dashboard first-screen UX on `codex/simplified-dashboard-ux`.
  - Direction: immediately visible today work list, with the fuller board/filter/timeline workflow hidden behind one quiet `전체 업무 보기` action.
